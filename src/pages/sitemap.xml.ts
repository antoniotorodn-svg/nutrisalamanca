...
const staticPages = [
  ...
  { url: '/nutricionista-centro-historico-salamanca', priority: '0.8', changefreq: 'monthly' },
  { url: '/nutricionista-barrio-del-oeste-salamanca', priority: '0.8', changefreq: 'monthly' },
  ...
  { url: '/nutricionista-sancti-spiritus-salamanca', priority: '0.8', changefreq: 'monthly' },
